...
- Jenin is home to a diverse population, contributing to the cultural mosaic of the region.",
    ...
    'Atlantis': "Atlantis (Ancient Greek: Ἀτλαντὶς νῆσος, romanized: Atlantìs nêsos, lit.'island of Atlas')\
is a fictional island mentioned in Plato's works Timaeus and Critias as part of an allegory on the hubris of nations.\
In the story, Atlantis is described as a naval empire that ruled all Western parts of the known world.\
making it the literary counter-image of the Achaemenid Empire. After an ill-fated attempt to conquer 'Ancient Athens,'\
Atlantis falls out of favor with the deities and submerges into the Atlantic Ocean.\
Since Plato describes Athens as resembling his ideal state in the Republic,\
the Atlantis story is meant to bear witness to the superiority of his concept of a state.\
Despite its minor importance in Plato's work, the Atlantis story has had a considerable impact on literature.\
The allegorical aspect of Atlantis was taken up in utopian works of several Renaissance writers, such as Francis Bacon's New Atlantis\
and Thomas More's Utopia.\
\n5f4cacec788b0c24225c53a25d8a3b369db982",
...
game_help_message = """
        ...
        Usage: game start
        Display information using the 'game -h' command.
        this is ctf game.
        
        Options:
          -h, --help           Display this help message and exit.
          start                Start the Game in new tab.
          restart              Restart the Game.
          stop                 Exit from the Game.
          
"""
hydra_help_message = """
        
        hydra is a brute force tool.
        Usage: hydra -p [ANY HASH]
               hydra list 
        Display information using the 'list -h' command.
        
        Options:
          -h, --help           Display this help message and exit.
          -p, --passwd       Enter the target hash.
          
"""

game_onscraen = """	GOOD WORK THE GAME STARTED.
the game ruls is to find the flag to pass the level.

"""

level_1 = """		LEVEL 1 (easy): 
HINT: use 'cd','ls'and'cat' to find the flag1.
"""

level_2 = """		LEVEL 2 (easy): 
HINT: the flag2 in 'Jaffa' city you have to find it.
"""

level_3 = """		LEVEL 3 (easy):
Atlantis is a fictional island mentioned in the works of Plato. I do not know if it existed at all, but I am sure that flag3 is there.
"""
level_4 = """		GOOD WORK
Wait the next updata or add more levels.
"""
